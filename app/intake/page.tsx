          ...
          <div>
            ...
            {goalLimitHit && (
              <div className="bg-green-400/10 border border-green-400/30 rounded-xl px-4 py-4 mb-4">
                ...
                <a href="/auth" className="inline-block bg-green-400 text-black text-xs font-semibold px-4 py-2 rounded-lg hover:bg-green-300 transition-colors">Upgrade to Pro - 12/month</a>
              </div>
            )}
